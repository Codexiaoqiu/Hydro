# ui-next Homepage Data Migration — Approved Design Spec

**Date:** 2026-07-07
**Status:** Approved (promoted from `docs/superpowers/plans/2026-07-07-ui-next-homepage-data-migration.md` after brainstorming sign-off; ready for implementation plan)
**Owner:** @hydro-dev
...
└── CLAUDE.md                                   # append ui-next section-types blurb (§8 step 5)
```
