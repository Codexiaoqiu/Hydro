...
function md5(s: string): string {
  ...
  function ff(a: number, b: number, c: number, d: number, x: number, shift: number, t: number) {
    return cmn((b & c) | (~b & d), a, b, x, shift, t);
  }
  function gg(a: number, b: number, c: number, d: number, x: number, shift: number, t: number) {
    return cmn((b & d) | (c & ~d), a, b, x, shift, t);
  }
  function hh(a: number, b: number, c: number, d: number, x: number, shift: number, t: number) {
    return cmn(b ^ c ^ d, a, b, x, shift, t);
  }
  function ii(a: number, b: number, c: number, d: number, x: number, shift: number, t: number) {
    return cmn(c ^ (b | ~d), a, b, x, shift, t);
  }
